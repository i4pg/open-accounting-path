...
(function () {
  ...
  var UI = {
    ...
    jurisdictions: { en: "Jurisdictions", ar: "الأطر المحلّية" },
    seq: { en: "Recommended sequencing", ar: "الترتيب المقترح" },
    builtH: { en: "How it was built", ar: "كيف أُعدّ هذا المنهج" },
    builtP: { en: "Designed by independent curriculum architects, resourced by web-research agents, adversarially link-verified, then graded against CPA/CMA/ACCA blueprints and gap-filled. Resources can still go stale — if a link has moved, search its title and provider.", ar: "صُمِّم بواسطة معماريي مناهج مستقلّين، وجُمعت مصادره عبر وكلاء بحث على الويب، وتُحقّق من روابطه بشكل نقدي، ثم قُيّم مقابل مخططات اختبارات CPA/CMA/ACCA وسُدّت الثغرات. قد تتقادم المصادر — إن تغيّر رابط فابحث عن عنوانه ومصدره." },
  ...
  function renderHome() {
    ...
    var ded = rtl()
      ? 'لِصديقي <b>عبدالعزيز</b> — ابدأ بقيدٍ واحد، وانتهِ متقنًا للغة الأعمال. هذا المسار كلّه لك، مجانًا للأبد. انطلق وابْنِ شيئًا. 🇸🇦'
      : 'For <b>Abdulaziz</b> — start with a single debit; finish fluent in the language of business. This whole path is yours, free forever. Go build something. 🇸🇦';
  ...
  function applyLang() {
    ...
    foot.innerHTML = rtl()
      ? '<span class="heart">♦</span> صُنع بمحبّة لصديقي <b>عبدالعزيز</b> — من أول قيد محاسبي إلى توقيع تقاريرك بنفسك. <span class="sep">·</span> مجاني للأبد <span class="sep">·</span> CC BY-SA 4.0'
      : '<span class="heart">♦</span> Made with care for my friend <b>Abdulaziz</b> — from your first journal entry to signing your own audit opinions. <span class="sep">·</span> Free forever <span class="sep">·</span> CC BY-SA 4.0';
  }
